...
# xclip is needed to use clip board, ctags is needed for a textadept module
    sudo pacman -S micro xclip ctags clangd lua-language-server
    ...
    wget https://github.com/YahYahDev/textadept/blob/main/textadept.tar.gz

    tar -xzvf textadept.tar.gz -C /home/$USER/
    mkdir /home/$USER/.textadept
    cp -r textadept /home/$USER/.textadept
