# MODIFIED FROM "halflife" THEME IN DEFAULT "oh-my-zsh"
...
PROMPT="${orange} %n %~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_ ${limegreen}>>  $reset_color%"
RPROMPT="${orange}%T  ${limegreen}|  ${orange}%W"
