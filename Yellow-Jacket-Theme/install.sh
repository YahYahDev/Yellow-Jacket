...
# picom is needed as a compositor for fancy stuff
    ...
    rm /home/$USER/.config/alacrity.toml
    cp alacritty/alacritty.toml /home/$USER/.config/alacrity/
...
# zsh, oh-my-zsh, zsh-syntax-highlighting, zsh-autosuggestions, ect
    ...
    cp .ohmyzsh/YellowJacket.zsh-theme /home/$USER/.oh-my-zsh/custom/themes
...
# xclip is needed to use clip board
    ...
    cp micro/colorschemes/Yellow-Jacket /home/$USER/.config/micro/colorschemes/
